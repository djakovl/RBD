...
FROM pg_temp.students ORDER BY surname, first_name, patronymic
"#;
...
JOIN pg_temp.students st ON st.id = e.student_id
JOIN faculty.student_groups g ON g.id = e.group_id
